document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        uk: {
            ...
            heroTitleHome: 'Системи накопичення<br>енергії для дому',
        ...
        en: {
            ...
            heroTitleBiz: 'Energy storage systems<br>for business',
            heroTitleHome: 'Energy storage systems<br>for the home',
            heroSubtitleBiz: 'Lower electricity costs.<br>Uninterrupted operation for your company.',
            heroSubtitleHome: 'Lower electricity costs.<br>Backup power for your home.',
            heroAudBiz: 'For business', heroAudHome: 'For home',
            heroHint: 'Preliminary estimate in 2 minutes',
            heroConsultTitle: 'Need a consultation?',
            heroConsultText: 'We will get in touch and size a solution',
            heroCall: 'Call us', heroWrite: 'Write to us',
            heroBtn1: 'Calculate ROI', heroBtn2: 'Get Consultation',
            painTitle: 'Why businesses lose money<br>on electricity',
            painTitleMobile: 'Why businesses<br>choose our<br>systems',
            ...
            equipSolIndKicker: 'Industrial solutions', equipSolIndTitle: 'For industrial needs', equipSolIndMeta: 'Factories · offices · commercial',
            equipSolHomeKicker: 'Residential solutions', equipSolHomeTitle: 'For household needs', equipSolHomeMeta: 'House · apartment · townhouse',
    ...
    if (inverterOptions && batteryOptions && EQUIP) {
        ...
        function updateEquipSpecs() {
            ...
            if (isHome) {
                ...
                alt = residential.batteryAlt[currentLang];
                imgSrc = residential.images.battery;
